...
const initialProducts = [
  { id: 201, inStock: true, isUsed: true, category: 'MONITORS', title: 'Dell P2419H 24-inch 1080p IPS Monitor', price: 'R 1,500.00', priceNum: 1500, image: '/images/screen_1.png' },
  { id: 202, inStock: true, isUsed: true, category: 'MONITORS', title: 'HP E243 23.8-inch FHD IPS Monitor', price: 'R 1,600.00', priceNum: 1600, image: '/images/screen_2.png' },
  { id: 203, inStock: true, isUsed: true, category: 'MONITORS', title: 'Lenovo ThinkVision T24i-10 24" Monitor', price: 'R 1,450.00', priceNum: 1450, image: '/images/screen_1.png' },
  { id: 204, inStock: true, isUsed: true, category: 'MONITORS', title: 'Samsung 27-inch Curved FHD Monitor', price: 'R 2,200.00', priceNum: 2200, image: '/images/screen_2.png' }
];
        ...
        <div className="category-layout">
          ...
          <div className="category-main">
            ...
            <div className="seo-text-box" style={{ marginTop: '4rem' }}>
              <p>Expand your view and boost your productivity with our range of high-quality monitors. From crisp 1080p displays for everyday office use to high-refresh-rate gaming monitors and professional-grade ultra-wides, find the perfect screen for your setup.</p>
              <p>We stock fully tested and refurbished monitors from trusted brands like Dell, HP, Samsung, and Lenovo, giving you a crystal clear display at a budget-friendly price. All refurbished monitors include a 6-month warranty.</p>
            </div>
          </div>
        </div>
      </div>
